...
.field static afo:Lcom/google/android/gms/gcm/GoogleCloudMessaging;


# instance fields
.field private afp:Landroid/app/PendingIntent;

.field final afq:Ljava/util/concurrent/BlockingQueue;
...
.field private afr:Landroid/os/Handler;

.field private afs:Landroid/os/Messenger;

.field private lM:Landroid/content/Context;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afq:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afr:Landroid/os/Handler;

    new-instance v0, Landroid/os/Messenger;

    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afr:Landroid/os/Handler;

    invoke-direct {v0, v1}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afs:Landroid/os/Messenger;
...
.method private a(Ljava/lang/String;Ljava/lang/String;JILandroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->lM:Landroid/content/Context;
...
.method private varargs e([Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->f([Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afs:Landroid/os/Messenger;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->lM:Landroid/content/Context;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afo:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afo:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    iput-object v2, v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->lM:Landroid/content/Context;
...
.method private mU()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afq:Ljava/util/concurrent/BlockingQueue;

    invoke-interface {v1}, Ljava/util/concurrent/BlockingQueue;->clear()V

    const-string v1, "google.messenger"

    iget-object v2, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afs:Landroid/os/Messenger;
...
.method public close()V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->mV()V

    return-void
.end method

.method varargs f([Ljava/lang/String;)Ljava/lang/String;
    .locals 4
...
.method declared-synchronized j(Landroid/content/Intent;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afp:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afp:Landroid/app/PendingIntent;

    :cond_0
    const-string v0, "app"

    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afp:Landroid/app/PendingIntent;
...
.method declared-synchronized mV()V
    .locals 1
...
.method public varargs register([Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->afq:Ljava/util/concurrent/BlockingQueue;

    invoke-interface {v0}, Ljava/util/concurrent/BlockingQueue;->clear()V

    invoke-direct {p0, p1}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->e([Ljava/lang/String;)V
...
.method public unregister()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->mU()V
