...
.method public static checkAppBeforeAuth(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    const-string v9, " with the scheme: "
    ...
    const-string v10, ").  Another app may be trying to  impersonate this app, so authentication will be disabled."
    ...
    const-string v9, " within your app\'s package registered for your URI scheme ("
    ...
    const-string v9, "). However, it appears that an activity in a different package is registered for that scheme instead. If you have multiple apps that all want to use the same accesstoken pair, designate one of them to do authentication and have the other apps launch it and then retrieve the token pair from it."
...
.method private startWebAuth(Ljava/lang/String;)V
    ...
    iget-object v7, p0, Lcom/dropbox/core/android/AuthActivity;->mAlreadyAuthedUids:[Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/dropbox/core/android/AuthActivity;->mAppKey:Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/dropbox/core/android/AuthActivity;->mApiType:Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/dropbox/core/android/AuthActivity;->mWebHost:Ljava/lang/String;

    invoke-static {v7, v8, v5, v4}, Lcom/dropbox/core/DbxRequestUtil;->buildUrlWithParams(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
