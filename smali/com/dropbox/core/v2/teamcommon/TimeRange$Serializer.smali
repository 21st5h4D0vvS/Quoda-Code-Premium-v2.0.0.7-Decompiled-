...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Z)Lcom/dropbox/core/v2/teamcommon/TimeRange;
    ...
    .line 207
    .local v1, "f_startTime":Ljava/util/Date;
    const/4 v0, 0x0

    .line 208
    .local v0, "f_endTime":Ljava/util/Date;
    :goto_0
    ...
    .end local v1    # "f_startTime":Ljava/util/Date;
    check-cast v1, Ljava/util/Date;

    .restart local v1    # "f_startTime":Ljava/util/Date;
    goto :goto_0
    ...
    .end local v0    # "f_endTime":Ljava/util/Date;
    check-cast v0, Ljava/util/Date;

    .restart local v0    # "f_endTime":Ljava/util/Date;
    goto :goto_0
    ...
    :cond_3
    new-instance v4, Lcom/dropbox/core/v2/teamcommon/TimeRange;

    invoke-direct {v4, v1, v0}, Lcom/dropbox/core/v2/teamcommon/TimeRange;-><init>(Ljava/util/Date;Ljava/util/Date;)V

    .line 226
    .local v4, "value":Lcom/dropbox/core/v2/teamcommon/TimeRange;
    if-nez p2, :cond_4
    ...
    .end local v0    # "f_endTime":Ljava/util/Date;
    .end local v1    # "f_startTime":Ljava/util/Date;
    .end local v4    # "value":Lcom/dropbox/core/v2/teamcommon/TimeRange;
    :cond_5
...
.method public serialize(Lcom/dropbox/core/v2/teamcommon/TimeRange;Lcom/fasterxml/jackson/core/JsonGenerator;Z)V
    .locals 2
    .param p1, "value"    # Lcom/dropbox/core/v2/teamcommon/TimeRange;
    ...
    iget-object v1, p1, Lcom/dropbox/core/v2/teamcommon/TimeRange;->endTime:Ljava/util/Date;
