...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Z)Lcom/dropbox/core/v2/files/UploadWriteFailed;
    ...
    .line 139
    .local v0, "f_reason":Lcom/dropbox/core/v2/files/WriteError;
    const/4 v1, 0x0

    .line 140
    .local v1, "f_uploadSessionId":Ljava/lang/String;
    :goto_0
    ...
    .line 144
    sget-object v5, Lcom/dropbox/core/v2/files/WriteError$Serializer;->INSTANCE:Lcom/dropbox/core/v2/files/WriteError$Serializer;

    invoke-virtual {v5, p1}, Lcom/dropbox/core/v2/files/WriteError$Serializer;->deserialize(Lcom/fasterxml/jackson/core/JsonParser;)Lcom/dropbox/core/v2/files/WriteError;
    ...
    .end local v1    # "f_uploadSessionId":Ljava/lang/String;
    check-cast v1, Ljava/lang/String;

    .restart local v1    # "f_uploadSessionId":Ljava/lang/String;
    goto :goto_0
    ...
    const-string v6, "Required field \"reason\" missing."
    ...
    const-string v6, "Required field \"upload_session_id\" missing."
    ...
    .line 159
    :cond_5
    new-instance v4, Lcom/dropbox/core/v2/files/UploadWriteFailed;

    invoke-direct {v4, v0, v1}, Lcom/dropbox/core/v2/files/UploadWriteFailed;-><init>(Lcom/dropbox/core/v2/files/WriteError;Ljava/lang/String;)V

    .line 164
    .local v4, "value":Lcom/dropbox/core/v2/files/UploadWriteFailed;
    if-nez p2, :cond_6
    ...
    .line 162
    .end local v0    # "f_reason":Lcom/dropbox/core/v2/files/WriteError;
    .end local v1    # "f_uploadSessionId":Ljava/lang/String;
    .end local v4    # "value":Lcom/dropbox/core/v2/files/UploadWriteFailed;
    :cond_7
    new-instance v5, Lcom/fasterxml/jackson/core/JsonParseException;
...
.method public serialize(Lcom/dropbox/core/v2/files/UploadWriteFailed;Lcom/fasterxml/jackson/core/JsonGenerator;Z)V
    .locals 2
    .param p1, "value"    # Lcom/dropbox/core/v2/files/UploadWriteFailed;
