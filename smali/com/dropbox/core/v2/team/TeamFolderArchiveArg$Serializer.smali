...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Z)Lcom/dropbox/core/v2/team/TeamFolderArchiveArg;
    ...
    .line 149
    .local v1, "f_teamFolderId":Ljava/lang/String;
    const/4 v5, 0x0
    ...
    .line 150
    .local v0, "f_forceAsyncOff":Ljava/lang/Boolean;
    :goto_0
    ...
    .line 153
    const-string v5, "team_folder_id"
    ...
    .end local v1    # "f_teamFolderId":Ljava/lang/String;
    check-cast v1, Ljava/lang/String;

    .restart local v1    # "f_teamFolderId":Ljava/lang/String;
    goto :goto_0

    .line 156
    :cond_1
    const-string v5, "force_async_off"
    ...
    .end local v0    # "f_forceAsyncOff":Ljava/lang/Boolean;
    check-cast v0, Ljava/lang/Boolean;

    .restart local v0    # "f_forceAsyncOff":Ljava/lang/Boolean;
    goto :goto_0
    ...
    const-string v6, "Required field \"team_folder_id\" missing."
    ...
    .line 166
    :cond_4
    new-instance v4, Lcom/dropbox/core/v2/team/TeamFolderArchiveArg;

    invoke-virtual {v0}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v5

    invoke-direct {v4, v1, v5}, Lcom/dropbox/core/v2/team/TeamFolderArchiveArg;-><init>(Ljava/lang/String;Z)V

    .line 171
    .local v4, "value":Lcom/dropbox/core/v2/team/TeamFolderArchiveArg;
    if-nez p2, :cond_5
    ...
    .end local v0    # "f_forceAsyncOff":Ljava/lang/Boolean;
    .end local v1    # "f_teamFolderId":Ljava/lang/String;
    .end local v4    # "value":Lcom/dropbox/core/v2/team/TeamFolderArchiveArg;
    :cond_6
    new-instance v5, Lcom/fasterxml/jackson/core/JsonParseException;
...
.method public serialize(Lcom/dropbox/core/v2/team/TeamFolderArchiveArg;Lcom/fasterxml/jackson/core/JsonGenerator;Z)V
    .locals 2
    .param p1, "value"    # Lcom/dropbox/core/v2/team/TeamFolderArchiveArg;
