...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Z)Lcom/dropbox/core/v2/team/RevokeDeviceSessionStatus;
    ...
    .line 142
    .local v0, "f_errorType":Lcom/dropbox/core/v2/team/RevokeDeviceSessionError;
    :goto_0
    ...
    .line 149
    sget-object v5, Lcom/dropbox/core/v2/team/RevokeDeviceSessionError$Serializer;->INSTANCE:Lcom/dropbox/core/v2/team/RevokeDeviceSessionError$Serializer;
    ...
    .end local v0    # "f_errorType":Lcom/dropbox/core/v2/team/RevokeDeviceSessionError;
    check-cast v0, Lcom/dropbox/core/v2/team/RevokeDeviceSessionError;

    .restart local v0    # "f_errorType":Lcom/dropbox/core/v2/team/RevokeDeviceSessionError;
    goto :goto_0
    ...
    const-string v6, "Required field \"success\" missing."
    ...
    .line 158
    :cond_4
    new-instance v4, Lcom/dropbox/core/v2/team/RevokeDeviceSessionStatus;

    invoke-virtual {v1}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v5

    invoke-direct {v4, v5, v0}, Lcom/dropbox/core/v2/team/RevokeDeviceSessionStatus;-><init>(ZLcom/dropbox/core/v2/team/RevokeDeviceSessionError;)V

    .line 163
    .local v4, "value":Lcom/dropbox/core/v2/team/RevokeDeviceSessionStatus;
    if-nez p2, :cond_5
    ...
    .end local v0    # "f_errorType":Lcom/dropbox/core/v2/team/RevokeDeviceSessionError;
    .end local v1    # "f_success":Ljava/lang/Boolean;
    .end local v4    # "value":Lcom/dropbox/core/v2/team/RevokeDeviceSessionStatus;
    :cond_6
    new-instance v5, Lcom/fasterxml/jackson/core/JsonParseException;
...
.method public serialize(Lcom/dropbox/core/v2/team/RevokeDeviceSessionStatus;Lcom/fasterxml/jackson/core/JsonGenerator;Z)V
    .locals 2
    .param p1, "value"    # Lcom/dropbox/core/v2/team/RevokeDeviceSessionStatus;
