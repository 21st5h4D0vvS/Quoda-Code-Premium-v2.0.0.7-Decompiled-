...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Z)Lcom/dropbox/core/v2/sharing/ListFileMembersCountResult;
    ...
    .line 136
    .local v1, "f_members":Lcom/dropbox/core/v2/sharing/SharedFileMembers;
    const/4 v0, 0x0

    .line 137
    .local v0, "f_memberCount":Ljava/lang/Long;
    :goto_0
    ...
    .line 141
    sget-object v5, Lcom/dropbox/core/v2/sharing/SharedFileMembers$Serializer;->INSTANCE:Lcom/dropbox/core/v2/sharing/SharedFileMembers$Serializer;

    invoke-virtual {v5, p1}, Lcom/dropbox/core/v2/sharing/SharedFileMembers$Serializer;->deserialize(Lcom/fasterxml/jackson/core/JsonParser;)Ljava/lang/Object;

    move-result-object v1

    .end local v1    # "f_members":Lcom/dropbox/core/v2/sharing/SharedFileMembers;
    check-cast v1, Lcom/dropbox/core/v2/sharing/SharedFileMembers;

    .restart local v1    # "f_members":Lcom/dropbox/core/v2/sharing/SharedFileMembers;
    goto :goto_0
    ...
    .end local v0    # "f_memberCount":Ljava/lang/Long;
    check-cast v0, Ljava/lang/Long;

    .restart local v0    # "f_memberCount":Ljava/lang/Long;
    goto :goto_0
    ...
    const-string v6, "Required field \"member_count\" missing."
    ...
    .line 156
    :cond_5
    new-instance v4, Lcom/dropbox/core/v2/sharing/ListFileMembersCountResult;

    invoke-virtual {v0}, Ljava/lang/Long;->longValue()J

    move-result-wide v6

    invoke-direct {v4, v1, v6, v7}, Lcom/dropbox/core/v2/sharing/ListFileMembersCountResult;-><init>(Lcom/dropbox/core/v2/sharing/SharedFileMembers;J)V

    .line 161
    .local v4, "value":Lcom/dropbox/core/v2/sharing/ListFileMembersCountResult;
    if-nez p2, :cond_6
    ...
    .end local v0    # "f_memberCount":Ljava/lang/Long;
    .end local v1    # "f_members":Lcom/dropbox/core/v2/sharing/SharedFileMembers;
    .end local v4    # "value":Lcom/dropbox/core/v2/sharing/ListFileMembersCountResult;
    :cond_7
    new-instance v5, Lcom/fasterxml/jackson/core/JsonParseException;
...
.method public serialize(Lcom/dropbox/core/v2/sharing/ListFileMembersCountResult;Lcom/fasterxml/jackson/core/JsonGenerator;Z)V
    .locals 4
    .param p1, "value"    # Lcom/dropbox/core/v2/sharing/ListFileMembersCountResult;
