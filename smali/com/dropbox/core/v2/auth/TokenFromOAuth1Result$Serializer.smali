...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Z)Lcom/dropbox/core/v2/auth/TokenFromOAuth1Result;
    ...
    .line 121
    .local v0, "f_oauth2Token":Ljava/lang/String;
    :goto_0
    ...
    .end local v0    # "f_oauth2Token":Ljava/lang/String;
    check-cast v0, Ljava/lang/String;

    .restart local v0    # "f_oauth2Token":Ljava/lang/String;
    goto :goto_0
    ...
    const-string v5, "Required field \"oauth2_token\" missing."
    ...
    .line 134
    :cond_3
    new-instance v3, Lcom/dropbox/core/v2/auth/TokenFromOAuth1Result;

    invoke-direct {v3, v0}, Lcom/dropbox/core/v2/auth/TokenFromOAuth1Result;-><init>(Ljava/lang/String;)V

    .line 139
    .local v3, "value":Lcom/dropbox/core/v2/auth/TokenFromOAuth1Result;
    if-nez p2, :cond_4
    ...
    .line 137
    .end local v0    # "f_oauth2Token":Ljava/lang/String;
    .end local v3    # "value":Lcom/dropbox/core/v2/auth/TokenFromOAuth1Result;
    :cond_5
    new-instance v4, Lcom/fasterxml/jackson/core/JsonParseException;
...
.method public serialize(Lcom/dropbox/core/v2/auth/TokenFromOAuth1Result;Lcom/fasterxml/jackson/core/JsonGenerator;Z)V
    .locals 2
    .param p1, "value"    # Lcom/dropbox/core/v2/auth/TokenFromOAuth1Result;
