.class public Lcom/henrythompson/quoda/filesystem/FTPServer;
...
.method constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lcom/henrythompson/quoda/filesystem/FTPServer;-><init>(Ljava/lang/String;)V
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mIsFirstListAttempt:Z
    ...
    iput-object v0, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mContext:Landroid/content/Context;
...
.method public connectAndLogIn()V
    ...
    iget-object v3, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mClient:Lorg/apache/commons/net/ftp/FTPClient;
    ...
    iput-object v3, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mClient:Lorg/apache/commons/net/ftp/FTPClient;
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->getPassword()Ljava/lang/String;
    ...
    const-string v4, "Creating new instance of FTPClient"
    ...
    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->getAddress()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->getPort()I
    ...
    const-string v4, "Failed to connect to FTP server"

    iget-object v5, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->getDisplayName()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->logOutAndDisconnect()V
    ...
    iget-object v3, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mContext:Landroid/content/Context;
    ...
    const-string v5, "Unable to connect to FTP server due to SocketError with message: "
    ...
    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->getUsername()Ljava/lang/String;
    ...
    const-string v5, "Unable to connect to FTP server due to IOError with message: "
...
.method public createNewFile(Ljava/util/ArrayList;Lcom/henrythompson/quoda/filesystem/FileObject;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->connectAndLogIn()V

    new-instance v3, Lcom/henrythompson/quoda/filesystem/FileObject;

    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->getUuid()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v4, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mClient:Lorg/apache/commons/net/ftp/FTPClient;

    invoke-virtual {v3}, Lcom/henrythompson/quoda/filesystem/FileObject;->getFilepath()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Lorg/apache/commons/net/ftp/FTPClient;->makeDirectory(Ljava/lang/String;)Z
    ...
    const-string v5, "Failed to create FTP folder"

    iget-object v6, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mContext:Landroid/content/Context;
    ...
    const-string v6, "IOException when creating blank FTP folder with message: "
    ...
    invoke-virtual {v4, v5, v2}, Lorg/apache/commons/net/ftp/FTPClient;->storeFile(Ljava/lang/String;Ljava/io/InputStream;)Z
    ...
    const-string v5, "Failed to create FTP file"
...
.method public getDefaultLocation()Lcom/henrythompson/quoda/filesystem/FileObject;
    ...
    invoke-virtual {p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->getInitialDirectory()Ljava/lang/String;
...
.method public listFolder(Lcom/henrythompson/quoda/filesystem/FileObject;)Ljava/util/ArrayList;
    ...
    :try_start_0
    iget-object v8, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mClient:Lorg/apache/commons/net/ftp/FTPClient;

    invoke-virtual {p1}, Lcom/henrythompson/quoda/filesystem/FileObject;->getFilepath()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v8, v9}, Lorg/apache/commons/net/ftp/FTPClient;->changeWorkingDirectory(Ljava/lang/String;)Z
    ...
    iget-object v8, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mContext:Landroid/content/Context;
    ...
    iget-boolean v8, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mIsFirstListAttempt:Z

    if-eqz v8, :cond_2

    iput-boolean v7, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mIsFirstListAttempt:Z

    invoke-virtual {p0, p1}, Lcom/henrythompson/quoda/filesystem/FTPServer;->listFolder(Lcom/henrythompson/quoda/filesystem/FileObject;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v9}, Lorg/apache/commons/net/ftp/FTPClient;->listFiles(Ljava/lang/String;)[Lorg/apache/commons/net/ftp/FTPFile;
    :try_end_1
    ...
    :cond_2
    iput-boolean v13, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mIsFirstListAttempt:Z
    ...
    iget-object v10, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mContext:Landroid/content/Context;
...
.method public logOutAndDisconnect()V
    ...
    iget-object v0, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mClient:Lorg/apache/commons/net/ftp/FTPClient;
    ...
    iput-object v0, p0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mClient:Lorg/apache/commons/net/ftp/FTPClient;
...
.method public openFile(Lcom/henrythompson/quoda/document/Document;Lcom/henrythompson/quoda/filesystem/FileObject;Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->connectAndLogIn()V
    ...
    iget-object v9, v0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mClient:Lorg/apache/commons/net/ftp/FTPClient;

    invoke-virtual/range {p2 .. p2}, Lcom/henrythompson/quoda/filesystem/FileObject;->getFilepath()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v9, v10, v3}, Lorg/apache/commons/net/ftp/FTPClient;->retrieveFile(Ljava/lang/String;Ljava/io/OutputStream;)Z
    :try_end_1
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->logOutAndDisconnect()V
    ...
    const-string v11, "Unable to open FTP file due to local IOException with message: "
    ...
    iget-object v11, v0, Lcom/henrythompson/quoda/filesystem/FTPServer;->mContext:Landroid/content/Context;
    ...
    const-string v10, "Unable to retrieve file from FTP"
...
.method public saveFile(Lcom/henrythompson/quoda/document/Document;Lcom/henrythompson/quoda/filesystem/FileObject;)V
    ...
    invoke-virtual {v8, v9, v3}, Lorg/apache/commons/net/ftp/FTPClient;->storeFile(Ljava/lang/String;Ljava/io/InputStream;)Z
...
.method public saveFile(Lcom/henrythompson/quoda/document/Document;Lcom/henrythompson/quoda/filesystem/FileObject;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/henrythompson/quoda/filesystem/FTPServer;->saveFile(Lcom/henrythompson/quoda/document/Document;Lcom/henrythompson/quoda/filesystem/FileObject;)V
