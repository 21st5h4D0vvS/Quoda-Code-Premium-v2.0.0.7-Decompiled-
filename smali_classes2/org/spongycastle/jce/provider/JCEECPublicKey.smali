...
.method private populateFromPubKeyInfo(Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;)V
    ...
    invoke-virtual {v1}, Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;->getObjectId()Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
...
.method public getEncoded()[B
    ...
    .line 322
    iget-object v13, p0, Lorg/spongycastle/jce/provider/JCEECPublicKey;->gostParams:Lorg/spongycastle/asn1/cryptopro/GOST3410PublicKeyAlgParameters;

    .line 347
    .local v13, "params":Lorg/spongycastle/asn1/ASN1Encodable;
    :goto_0
    ...
    invoke-direct {p0, v10, v2, v6}, Lorg/spongycastle/jce/provider/JCEECPublicKey;->extractBytes([BILjava/math/BigInteger;)V

    .line 352
    const/16 v2, 0x20

    invoke-direct {p0, v10, v2, v7}, Lorg/spongycastle/jce/provider/JCEECPublicKey;->extractBytes([BILjava/math/BigInteger;)V

    .line 356
    :try_start_0
    new-instance v11, Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;
    ...
    invoke-direct {v2, v3, v13}, Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;-><init>(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/asn1/ASN1Encodable;)V

    new-instance v3, Lorg/spongycastle/asn1/DEROctetString;

    invoke-direct {v3, v10}, Lorg/spongycastle/asn1/DEROctetString;-><init>([B)V

    invoke-direct {v11, v2, v3}, Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;-><init>(Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;Lorg/spongycastle/asn1/ASN1Encodable;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .local v11, "info":Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;
    :goto_1
    invoke-static {v11}, Lorg/spongycastle/jcajce/provider/asymmetric/util/KeyUtil;->getEncodedSubjectPublicKeyInfo(Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;)[B

    move-result-object v2

    .end local v11    # "info":Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;
    :goto_2
    return-object v2

    .line 326
    .end local v13    # "params":Lorg/spongycastle/asn1/ASN1Encodable;
    :cond_0
    ...
    .line 328
    new-instance v13, Lorg/spongycastle/asn1/cryptopro/GOST3410PublicKeyAlgParameters;
    ...
    invoke-direct {v13, v2, v3}, Lorg/spongycastle/asn1/cryptopro/GOST3410PublicKeyAlgParameters;-><init>(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/asn1/ASN1ObjectIdentifier;)V

    .restart local v13    # "params":Lorg/spongycastle/asn1/ASN1Encodable;
    goto :goto_0
    ...
    new-instance v13, Lorg/spongycastle/asn1/x9/X962Parameters;

    invoke-direct {v13, v0}, Lorg/spongycastle/asn1/x9/X962Parameters;-><init>(Lorg/spongycastle/asn1/x9/X9ECParameters;)V
    ...
    invoke-direct {v13, v8}, Lorg/spongycastle/asn1/x9/X962Parameters;-><init>(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;)V
    ...
    .line 396
    .local v12, "p":Lorg/spongycastle/asn1/ASN1OctetString;
    new-instance v11, Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;
    ...
    invoke-direct {v11, v2, v3}, Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;-><init>(Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;[B)V

    .restart local v11    # "info":Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;
    goto/16 :goto_1

    .line 374
    .end local v1    # "curve":Lorg/spongycastle/math/ec/ECCurve;
    .end local v11    # "info":Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;
    .end local v12    # "p":Lorg/spongycastle/asn1/ASN1OctetString;
    .end local v13    # "params":Lorg/spongycastle/asn1/ASN1Encodable;
    :cond_4
    iget-object v2, p0, Lorg/spongycastle/jce/provider/JCEECPublicKey;->ecSpec:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v13, v2}, Lorg/spongycastle/asn1/x9/X962Parameters;-><init>(Lorg/spongycastle/asn1/ASN1Primitive;)V
