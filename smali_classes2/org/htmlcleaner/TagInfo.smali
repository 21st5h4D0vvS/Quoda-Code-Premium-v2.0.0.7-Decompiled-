...
.method public constructor <init>(Ljava/lang/String;IIZZZ)V
    ...
    .param p3, "belongsTo"    # I
    .param p4, "depricated"    # Z
    .param p5, "unique"    # Z
    .param p6, "ignorePermitted"    # Z
...
.method allowsItem(Lorg/htmlcleaner/BaseToken;)Z
    ...
    .end local p1    # "token":Lorg/htmlcleaner/BaseToken;
    :cond_0
    :goto_0
    return v3

    .line 371
    .restart local p1    # "token":Lorg/htmlcleaner/BaseToken;
    :cond_1
    iget v4, p0, Lorg/htmlcleaner/TagInfo;->contentType:I
...
.method public defineAllowedChildrenTags(Ljava/lang/String;)V
    .locals 4
    .param p1, "commaSeparatedListOfTags"    # Ljava/lang/String;
...
.method public setChildTags(Ljava/util/Set;)V
    .locals 0
    .param p1, "childTags"    # Ljava/util/Set;
...
.method public setContinueAfterTags(Ljava/util/Set;)V
    .locals 0
    .param p1, "continueAfterTags"    # Ljava/util/Set;
...
.method public setCopyTags(Ljava/util/Set;)V
    .locals 0
    .param p1, "copyTags"    # Ljava/util/Set;
...
.method public setFatalTag(Ljava/lang/String;)V
    .locals 0
    .param p1, "fatalTag"    # Ljava/lang/String;
...
.method public setHigherTags(Ljava/util/Set;)V
    .locals 0
    .param p1, "higherTags"    # Ljava/util/Set;
...
.method public setMustCloseTags(Ljava/util/Set;)V
    .locals 0
    .param p1, "mustCloseTags"    # Ljava/util/Set;
...
.method public setPermittedTags(Ljava/util/Set;)V
    .locals 0
    .param p1, "permittedTags"    # Ljava/util/Set;
...
.method public setRequiredParent(Ljava/lang/String;)V
    .locals 0
    .param p1, "requiredParent"    # Ljava/lang/String;
